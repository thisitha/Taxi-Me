                    ...
                    child: RaisedButton(
                      ...
                      child: Column(
                        children: [
                          pickup_place == null
                              ? Container()
                              : Text(pickup_place.display_name ?? ""),
                          SizedBox(
                            height: 10,
                          ),
                          Container(
    ...
    return FlutterMap(
      ...
      options: MapOptions(
        center: pickup_place != null
            ?LatLng(pickup_place.lat, pickup_place.long):_currentLocation!=null?LatLng(_currentLocation.latitude, _currentLocation.longitude):LatLng(6.965176, 79.922377),
        zoom: 10,
      ),
      layers: [
        TileLayerOptions(
